                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    newinvitation += invitationid.concat("/");
                                    boolean done = false;
                                ...
                                session.setUserInvitation(newinvitation);
                            }
                        }catch (JSONException e) {
                            e.printStackTrace();
                        }
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                session.setAnnouncement(announcement);
                            }
                        }catch (JSONException e) {
                            e.printStackTrace();
                        }
