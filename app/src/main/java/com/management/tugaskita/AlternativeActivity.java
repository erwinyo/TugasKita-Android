...
public class AlternativeActivity extends AppCompatActivity implements DialogError.DialogErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web_altact_webview .loadUrl("http://tugaskita.epizy.com/tugaskita/");
